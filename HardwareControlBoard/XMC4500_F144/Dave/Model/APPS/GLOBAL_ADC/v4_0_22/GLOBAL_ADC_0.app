...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="GLOBAL_ADC" URI="http://resources/4.0.22/app/GLOBAL_ADC/0" description="Initializes VADC GLOBAL and GROUP resources." version="4.0.22" minDaveVersion="4.0.0" instanceLabel="GLOBAL_ADC_0" appLabel="">
  <upwardMapList xsi:type="ResourceModel:RequiredApp" href="../../ADC_MEASUREMENT_ADV/v4_0_20/ADC_MEASUREMENT_ADV_0.app#//@requiredApps.22"/>
  <upwardMapList xsi:type="ResourceModel:RequiredApp" href="../../ADC_MEASUREMENT_ADV/v4_0_20/ADC_MEASUREMENT_ADV_1.app#//@requiredApps.22"/>
  ...
  <virtualSignals name="global_signal" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/vs_global_adc_global" hwSignal="global_signal" hwResource="//@hwResources.1" visible="true">
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../ADC_MEASUREMENT_ADV/v4_0_20/ADC_MEASUREMENT_ADV_0.app#//@connections.165"/>
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../ADC_MEASUREMENT_ADV/v4_0_20/ADC_MEASUREMENT_ADV_0.app#//@connections.167"/>
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../ADC_MEASUREMENT_ADV/v4_0_20/ADC_MEASUREMENT_ADV_1.app#//@connections.165"/>
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../ADC_MEASUREMENT_ADV/v4_0_20/ADC_MEASUREMENT_ADV_1.app#//@connections.167"/>
  </virtualSignals>
  ...
  <virtualSignals name="group0_end_of_sampling_signal" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/vs_global_adc_g0_gsample" hwSignal="gsample" hwResource="//@hwResources.2" visible="true"/>
  ...
  <virtualSignals name="group1_end_of_sampling_signal" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/vs_global_adc_g1_gsample" hwSignal="gsample" hwResource="//@hwResources.3" visible="true"/>
  ...
  <virtualSignals name="group2_end_of_arbitration_round" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/vs_global_adc_g2_garbcnt" hwSignal="garbcnt" hwResource="//@hwResources.4" visible="true"/>
  <virtualSignals name="group2_end_of_sampling_signal" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/vs_global_adc_g2_gsample" hwSignal="gsample" hwResource="//@hwResources.4" visible="true"/>
  <virtualSignals name="group2_input_queue" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/vs_global_adc_g2_gqueuereq" hwSignal="gqueuereq" hwResource="//@hwResources.4" visible="true"/>
  <virtualSignals name="group2_input_scan" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/vs_global_adc_g2_gscanreq" hwSignal="gscanreq" hwResource="//@hwResources.4" visible="true"/>
  <virtualSignals name="group2_sync_request_signal" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/vs_global_adc_g2_gsyncreq" hwSignal="gsyncreq" hwResource="//@hwResources.4" visible="true"/>
  <virtualSignals name="group3_end_of_arbitration_round" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/vs_global_adc_g3_garbcnt" hwSignal="garbcnt" hwResource="//@hwResources.5" visible="true"/>
  <virtualSignals name="group3_end_of_sampling_signal" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/vs_global_adc_g3_gsample" hwSignal="gsample" hwResource="//@hwResources.5" visible="true"/>
  <virtualSignals name="group3_input_queue" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/vs_global_adc_g3_gqueuereq" hwSignal="gqueuereq" hwResource="//@hwResources.5" visible="true"/>
  <virtualSignals name="group3_input_scan" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/vs_global_adc_g3_gscanreq" hwSignal="gscanreq" hwResource="//@hwResources.5" visible="true"/>
  <virtualSignals name="group3_sync_request_signal" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/vs_global_adc_g3_gsyncreq" hwSignal="gsyncreq" hwResource="//@hwResources.5" visible="true"/>
  ...
  <hwResources name="Group2" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/hwres_vadc_group2" resourceGroupUri="peripheral/vadc/*/group/2/config" mResGrpUri="peripheral/vadc/*/group/2/config">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/VADC/VADC_0.dd#//@provided.12"/>
  </hwResources>
  <hwResources name="Group3" URI="http://resources/4.0.22/app/GLOBAL_ADC/0/hwres_vadc_group3" resourceGroupUri="peripheral/vadc/*/group/3/config" mResGrpUri="peripheral/vadc/*/group/3/config">
