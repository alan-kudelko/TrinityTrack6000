...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PIN_INTERRUPT" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0" description="The PIN_INTERRUPT APP invokes user interrupt handler in a response &#xA;to rising and/or falling edge event signal on a pin." mode="NOTSHARABLE" version="4.0.4" minDaveVersion="4.0.0" instanceLabel="PIN_INTERRUPT_Kill_Input" appLabel="">
  <properties provideInit="true"/>
  <virtualSignals name="signal_a_b" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_input_A_B" hwResource="//@hwResources.2" visible="true" solverVariableName="sv0" solverVariableValue="b"/>
  ...
  <virtualSignals name="trigger_out" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_TriggerPulse" hwSignal="tr" hwResource="//@hwResources.2"/>
  <virtualSignals name="trigger_in" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_trin" hwSignal="trin" hwResource="//@hwResources.3"/>
  <virtualSignals name="ogu_iout" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_iout" hwSignal="iout" hwResource="//@hwResources.3"/>
  <virtualSignals name="sr_node" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_signal" hwSignal="signal_in" hwResource="//@hwResources.0"/>
  <virtualSignals name="erunmi_in" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_erunmi_in" hwSignal="in" hwResource="//@hwResources.4"/>
  <virtualSignals name="iout" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_erunmi_out" hwSignal="out" hwResource="//@hwResources.4"/>
  <virtualSignals name="Pin_signal" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/__pin_vs_pin_interrupt_iopad" hwSignal="pin" hwResource="//@hwResources.5"/>
  <requiredApps URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/appres_cpu" requiredAppName="CPU_CTRL_XMC4" requiringMode="SHARABLE">
    <downwardMapList xsi:type="ResourceModel:App" href="../../CPU_CTRL_XMC4/v4_0_18/CPU_CTRL_XMC4_0.app#/"/>
  </requiredApps>
  <hwResources name="External Event" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/hwres_interrupt" resourceGroupUri="peripheral/cpu/0/nvic/interrupt/*" mResGrpUri="peripheral/cpu/0/nvic/interrupt/*">
  ...
  <hwResources name="erunmi" URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/hwres_scu_gcu_interrupt_erunmi" resourceGroupUri="peripheral/scu/*/gcu/interrupt/erunmi/*" mResGrpUri="peripheral/scu/*/gcu/interrupt/erunmi/*">
  ...
  <connections URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_iout/http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_erunmi_in" systemDefined="true" sourceSignal="ogu_iout" targetSignal="erunmi_in" srcVirtualSignal="//@virtualSignals.4" targetVirtualSignal="//@virtualSignals.6"/>
  <connections URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_erunmi_out/http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_signal" systemDefined="true" sourceSignal="iout" targetSignal="sr_node" srcVirtualSignal="//@virtualSignals.7" targetVirtualSignal="//@virtualSignals.5"/>
  <connections URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_iopad/http://resources/4.0.4/app/PIN_INTERRUPT/0/__pin_vs_pin_interrupt_iopad" systemDefined="true" sourceSignal="external_event_pin" targetSignal="Pin_signal" srcVirtualSignal="//@virtualSignals.1" targetVirtualSignal="//@virtualSignals.8"/>
  <connections URI="http://resources/4.0.4/app/PIN_INTERRUPT/0/http://resources/4.0.4/app/PIN_INTERRUPT/0/__pin_vs_pin_interrupt_iopad/http://resources/4.0.4/app/PIN_INTERRUPT/0/vs_pin_interrupt_iopad" systemDefined="true" sourceSignal="Pin_signal" targetSignal="external_event_pin" srcVirtualSignal="//@virtualSignals.8" targetVirtualSignal="//@virtualSignals.1"/>
</ResourceModel:App>
