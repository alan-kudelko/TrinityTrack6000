...
- ✅ Fix **Core blocked** issue after uploading the `.elf` file generated by CMake
- 🔄 Build `.elf` and `.map` with debug symbols for flashing and debugging
- 🔄 Implement initialization functions to initialize STM32's components
