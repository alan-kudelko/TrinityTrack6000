...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="UART" URI="http://resources/4.1.14/app/UART/0" description="UART APP configures a USIC channel to perform &#xA;transmit &amp; receive operations using UART protocol." mode="NOTSHARABLE" version="4.1.14" minDaveVersion="4.0.0" instanceLabel="UART_DEBUG" appLabel="">
  ...
  <requiredApps URI="http://resources/4.1.14/app/UART/0/appres_clock" requiredAppName="CLOCK_XMC4" requiringMode="SHARABLE">
    <downwardMapList xsi:type="ResourceModel:App" href="../../CLOCK_XMC4/v4_0_24/CLOCK_XMC4_0.app#/"/>
  </requiredApps>
  <requiredApps URI="http://resources/4.1.14/app/UART/0/appres_cpu" requiredAppName="CPU_CTRL_XMC4" requiringMode="SHARABLE">
  ...
  <hwResources name="Channel" URI="http://resources/4.1.14/app/UART/0/hwres_usic_ch" resourceGroupUri="peripheral/usic/1/channel/0" constraintType="GLOBAL_RESOURCE" mResGrpUri="peripheral/usic/*/channel/*">
  ...
  <hwResources name="Receive Pin" URI="http://resources/4.1.14/app/UART/0/hwres_port_pad_uart_rx" resourceGroupUri="port/p/*/pad/*" mResGrpUri="port/p/*/pad/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/Port2/Port2_2.dd#//@provided.33"/>
  </hwResources>
  ...
  <hwResources name="Receive Pin" URI="http://resources/4.1.14/app/UART/0/__pin_hwres_port_pad_uart_rx" resourceGroupUri="devicepackage/0/25" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.21"/>
  </hwResources>
  <hwResources name="Transmit Pin" URI="http://resources/4.1.14/app/UART/0/__pin_hwres_port_pad_uart_tx" resourceGroupUri="devicepackage/0/26" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.1.14/app/UART/0/http://resources/4.1.14/app/UART/0/vs_uart_std_tx_int/http://resources/4.1.14/app/UART/0/vs_dst_trigger_dlr_tx_in" systemDefined="true" sourceSignal="event_transmit_buffer" targetSignal="destination_trigger" required="false" srcVirtualSignal="//@virtualSignals.5" targetVirtualSignal="//@virtualSignals.16"/>
  <connections URI="http://resources/4.1.14/app/UART/0/http://resources/4.1.14/app/UART/0/vs_uart_std_rx_int/http://resources/4.1.14/app/UART/0/vs_src_trigger_dlr_rx_in" systemDefined="true" sourceSignal="event_std_receive" targetSignal="source_trigger" required="false" srcVirtualSignal="//@virtualSignals.6" targetVirtualSignal="//@virtualSignals.15"/>
  <connections URI="http://resources/4.1.14/app/UART/0/http://resources/4.1.14/app/UART/0/vs_uart_alt_rx_int/http://resources/4.1.14/app/UART/0/vs_src_trigger_dlr_rx_in" systemDefined="true" sourceSignal="event_alt_receive" targetSignal="source_trigger" required="false" srcVirtualSignal="//@virtualSignals.7" targetVirtualSignal="//@virtualSignals.15"/>
  <connections URI="http://resources/4.1.14/app/UART/0/http://resources/4.1.14/app/UART/0/vs_dma_interrupt_tx/http://resources/4.1.14/app/UART/0/vsra_gpdma_interrupt" systemDefined="true" sourceSignal="DMA Transfer complete event" required="false" srcVirtualSignal="//@virtualSignals.19" containingProxySignal="true"/>
  <connections URI="http://resources/4.1.14/app/UART/0/http://resources/4.1.14/app/UART/0/vs_dma_interrupt_rx/http://resources/4.1.14/app/UART/0/vsra_gpdma_interrupt" systemDefined="true" sourceSignal="DMA Transfer complete event" required="false" srcVirtualSignal="//@virtualSignals.20" containingProxySignal="true"/>
  <connections URI="http://resources/4.1.14/app/UART/0/http://resources/4.1.14/app/UART/0/vs_dst_trigger_dlr_tx_out/http://resources/4.1.14/app/UART/0/vs_dma_ch_dst_req_tx" systemDefined="true" sourceSignal="dlr_out" targetSignal="Destination request" required="false" srcVirtualSignal="//@virtualSignals.18" targetVirtualSignal="//@virtualSignals.21"/>
  <connections URI="http://resources/4.1.14/app/UART/0/http://resources/4.1.14/app/UART/0/vs_src_trigger_dlr_rx_out/http://resources/4.1.14/app/UART/0/vs_dma_ch_src_req_rx" systemDefined="true" sourceSignal="dlr_out" targetSignal="Source request" required="false" srcVirtualSignal="//@virtualSignals.17" targetVirtualSignal="//@virtualSignals.22"/>
