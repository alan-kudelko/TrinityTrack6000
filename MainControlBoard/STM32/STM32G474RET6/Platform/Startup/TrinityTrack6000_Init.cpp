...
void MX_TIM1_Init(void){
  ...
  /* USER CODE BEGIN TIM1_Init 2 */
  __HAL_TIM_ENABLE_OCxPRELOAD(&htim1, TIM_CHANNEL_4); // Modified
  /* USER CODE END TIM1_Init 2 */
  HAL_TIM_MspPostInit(&htim1);
}
...
void MX_GPIO_Init(void){
  ...
  HAL_GPIO_WritePin(GPIOC, KILL_SWITCH_Pin|WATCHDOG_EN_Pin|GPS_STANDBY_Pin|WATCHDOG_FEED_Pin
                          |NRF24L01_PWR_Pin|NRF24L01_CE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, ARM_GUN_Pin|FIRE_GUN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, GPS_RST_Pin|RENESANS_CS_Pin|NXP_CS_Pin|FPGA_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, NRF24L01_CS_Pin|FRAM_CS_Pin|INFINEON_RST_Pin|INFINEON_CS_Pin
                          |NXP_RST_Pin|FPGA_RST_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(RENESANS_RST_GPIO_Port, RENESANS_RST_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : NC_5_Pin NC_3_Pin NC_2_Pin NC_1_Pin */
  GPIO_InitStruct.Pin = NC_5_Pin|NC_3_Pin|NC_2_Pin|NC_1_Pin;
  ...
  /*Configure GPIO pins : NC_4_Pin GPS_PPS1_Pin */
  GPIO_InitStruct.Pin = NC_4_Pin|GPS_PPS1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : INFINEON_RST_Pin NXP_RST_Pin FPGA_RST_Pin */
  GPIO_InitStruct.Pin = INFINEON_RST_Pin|NXP_RST_Pin|FPGA_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : RENESANS_CS_Pin NXP_CS_Pin FPGA_CS_Pin */
  GPIO_InitStruct.Pin = RENESANS_CS_Pin|NXP_CS_Pin|FPGA_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : NXP_RDY_Pin FPGA_RDY_Pin */
  GPIO_InitStruct.Pin = NXP_RDY_Pin|FPGA_RDY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
...
// Custom initialization sequence
	initializeMemory();
	while(usart3_dma_enq_data((uint8_t*)msg_init_memory_initialized_info,strlen(msg_init_memory_initialized_info))!=true){
		HAL_Delay(10);
	}
// Initialize hardware
  //nrf24l01_init();
