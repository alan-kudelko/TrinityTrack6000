...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA1     ------> ADC1_IN2
    */
    GPIO_InitStruct.Pin = MQ6_IN_Pin|MQ7_IN_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA1     ------> ADC1_IN2
    */
    HAL_GPIO_DeInit(GPIOA, MQ6_IN_Pin|MQ7_IN_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    */
    ...
    /* SPI2_TX Init */
    hdma_spi2_tx.Instance = DMA2_Channel1;
  ...
  else if(hspi->Instance==SPI3)
  {
    ...
    */
    ...
    /* SPI3 DMA Init */
    /* SPI3_TX Init */
    hdma_spi3_tx.Instance = DMA1_Channel7;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if(htim->Instance==TIM20)
  {
    ...
    PC2     ------> TIM20_CH2
    */
    GPIO_InitStruct.Pin = MQ_HEATERS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_TIM20;
    HAL_GPIO_Init(MQ_HEATERS_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    */
    ...
    /* USART3 DMA Init */
    /* USART3_RX Init */
    hdma_usart3_rx.Instance = DMA2_Channel4;
    ...
    /* USART3_TX Init */
    hdma_usart3_tx.Instance = DMA2_Channel5;
