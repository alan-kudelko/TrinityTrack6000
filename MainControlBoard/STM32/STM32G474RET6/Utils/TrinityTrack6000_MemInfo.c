...
// Send General RAM diagnostics headers 1-3
	while(usart3_dma_enq_data((uint8_t*)msg_ramDiagnosticsGeneral_header1,strlen(msg_ramDiagnosticsGeneral_header1))!=true){
		pSleepFn(sleepTimeout);
	}
	while(usart3_dma_enq_data((uint8_t*)msg_ramDiagnosticsGeneral_header2,strlen(msg_ramDiagnosticsGeneral_header2))!=true){
		pSleepFn(sleepTimeout);
	}
	while(usart3_dma_enq_data((uint8_t*)msg_ramDiagnosticsGeneral_header3,strlen(msg_ramDiagnosticsGeneral_header3))!=true){
		pSleepFn(sleepTimeout);
	}
// Send RAM1 info
	...
	while(usart3_dma_enq_data((uint8_t*)buffer,strlen(buffer))!=true){
		pSleepFn(sleepTimeout);
	}
// Send RAM2 info
...
// Send RAM diagnostics footers
	while(usart3_dma_enq_data((uint8_t*)msg_ramDiagnosticsGeneral_footer1,strlen(msg_ramDiagnosticsGeneral_footer1))!=true){
		pSleepFn(sleepTimeout);
	}
	while(usart3_dma_enq_data((uint8_t*)msg_ramDiagnosticsGeneral_footer2,strlen(msg_ramDiagnosticsGeneral_footer2))!=true){
		pSleepFn(sleepTimeout);
	}
// Send empty line
...
// Send RAM1 diagnostics headers 1-3
	while(usart3_dma_enq_data((uint8_t*)msg_ramDiagnosticsRAM1_header1,strlen(msg_ramDiagnosticsRAM1_header1))!=true){
		pSleepFn(sleepTimeout);
	}
	while(usart3_dma_enq_data((uint8_t*)msg_ramDiagnosticsRAM1_header2,strlen(msg_ramDiagnosticsRAM1_header2))!=true){
		pSleepFn(sleepTimeout);
	}
	while(usart3_dma_enq_data((uint8_t*)msg_ramDiagnosticsRAM1_header3,strlen(msg_ramDiagnosticsRAM1_header3))!=true){
		pSleepFn(sleepTimeout);
	}
...
// Send RAM2 diagnostics headers 1-3
	while(usart3_dma_enq_data((uint8_t*)msg_ramDiagnosticsRAM2_header1,strlen(msg_ramDiagnosticsRAM2_header1))!=true){
		pSleepFn(sleepTimeout);
	}
	while(usart3_dma_enq_data((uint8_t*)msg_ramDiagnosticsRAM1_header2,strlen(msg_ramDiagnosticsRAM1_header2))!=true){
		pSleepFn(sleepTimeout);
...
// Send CCSRAM diagnostics headers 1-3
	while(usart3_dma_enq_data((uint8_t*)msg_ramDiagnosticsCCSRAM_header1,strlen(msg_ramDiagnosticsCCSRAM_header1))!=true){
		pSleepFn(sleepTimeout);
	}
	while(usart3_dma_enq_data((uint8_t*)msg_ramDiagnosticsRAM1_header2,strlen(msg_ramDiagnosticsRAM1_header2))!=true){
		pSleepFn(sleepTimeout);
